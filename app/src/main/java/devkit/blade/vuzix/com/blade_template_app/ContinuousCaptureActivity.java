...
import devkit.blade.vuzix.com.blade_template_app.R;
...
public class ContinuousCaptureActivity extends Activity implements SurfaceHolder.Callback,
    ...
    private static final String TAG = "ContinuousCaptureAct";
...
//    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
    public void onRequestPermissionsResult(int requestCode, String[] permissions, int[] grantResults) {
        ...
        Log.d(TAG, "Camera permission is needed to run this application");
